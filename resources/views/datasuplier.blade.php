												    ...
												    <div class="modal-content">
												      ...
												      <form action="{{ route('barangmasuk.update', $item->id) }}" method="POST" enctype="multipart/form-data">
												        ...
												        <div class="modal-body">
												          ...
												          <div class="form-group">
												            <label for="satuan_id{{ $item->id }}">Satuan</label>
												            <select class="form-control" id="satuan_id{{ $item->id }}" name="satuan_id" required>
												              <option value="">-- Pilih Satuan --</option>
												              @foreach($satuan as $sat)
												          ...
												          <div class="form-group">
												            <label for="stok{{ $item->id }}">Stok</label>
												            <input type="number" class="form-control" id="stok{{ $item->id }}" name="stok" value="{{ $item->stok }}" min="0" required>
												          </div>
												          <div class="form-group">
												          ...
												          <div class="form-group">
												            <label for="jumlah_masuk{{ $item->id }}">Jumlah Masuk</label>
												            <input type="number" class="form-control" id="jumlah_masuk{{ $item->id }}" name="jumlah_masuk" value="{{ $item->jumlah_masuk }}" min="1" required>
												          </div>
												          <div class="form-group">
												            <label for="sisa_stok{{ $item->id }}">Sisa Stok</label>
												            <input type="number" class="form-control" id="sisa_stok{{ $item->id }}" name="sisa_stok" value="{{ $item->sisa_stok }}" min="0" required>
												          </div>
												          <div class="form-group">
												          ...
												          <div class="form-group">
												            <label for="gambar{{ $item->id }}">Upload Gambar/ File</label>
												            <input type="file" class="form-control-file" id="gambar{{ $item->id }}" name="gambar" accept="image/*" capture="environment">
												            @if($item->gambar)
												              <div class="mt-2">
												                <img src="{{ asset('storage/' . $item->gambar) }}" alt="Gambar Barang" width="80" class="img-thumbnail mb-1">
												                <a href="{{ asset('storage/' . $item->gambar) }}" target="_blank" class="btn btn-info btn-sm">Lihat/Download</a>
												              </div>
												            @endif
												          </div>
												        </div>
