                    ...
                    <div class="row mt--2">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body ">
                                    <form method="GET" action="{{ route('laporan-keluar') }}" class="w-100">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 py-3 py-md-0 mt-sm-4 d-flex gap-2 align-items-center">
                                                ...
                                                <a class="btn btn-success" href="{{ route('laporan-keluar.export-excel', ['tanggal_awal' => request('tanggal_awal'), 'tanggal_akhir' => request('tanggal_akhir')]) }}">
                                                    <span class="btn-label">
