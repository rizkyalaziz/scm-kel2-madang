...
<head>
	...
	<link rel="icon" href="../assets/img/MADANGG.png" type="image/x-icon" />
							...
							<div class="card card-stats card-round">
								<div class="card-body">
									<div class="row align-items-center">
										...
										<div class="col col-stats ml-3 ml-sm-0">
											<div class="numbers">
												<p class="card-category">Barang Retur</p>
												<h4 class="card-title">1</h4>
											</div>
										</div>
									</div>
							...
							<div class="card card-stats card-round">
								<div class="card-body">
									<div class="row align-items-center">
										...
										<div class="col col-stats ml-3 ml-sm-0">
											<div class="numbers">
												<p class="card-category">Barang Kedaluwarsa</p>
												<h4 class="card-title">1</h4>
											</div>
										</div>
									</div>
